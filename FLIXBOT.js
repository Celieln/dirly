...
let audio = {
  ...
  let verif = {
            ...
            { remoteJid: "6285167249152-1625305606@g.us" } : {}) 
                       },
            message: {
...
"message": {
"groupInviteMessage": {
"groupJid": "6285167249152-1616169743@g.us",
"inviteCode": "m",
...
console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32m 𝘒𝘢𝘻𝘶𝘩𝘢-𝘔𝘋 \x1b[1;37m]', time, chalk.green(budy || m.mtype), 'Dari', chalk.blue(pushname), 'Di', chalk.yellow(groupName ? groupName : 'Private Chat' ), 'args :', chalk.white(args.length))
            }
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttonParamsJson: [
            {
              ...
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"YOUTUBE\",\"url\":\"https://youtube.com/@slnckyami\",\"merchant_url\":\"https://www.google.com\"}"
              },              
              {
                 "name": "cta_url",
...
case 'socialmedia': 
    ...
    [
        ...
        'https://youtube.com/@slnckyami', // Command (URL in this case)
        'cta_url', // Button type
        'https://youtube.com/@slnckyami' // URL (used in image generation)
    ], 
    [
    ...
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'https://Wa.me/123233', // Command (URL in this case)
        'cta_url', // Button type
        'https://Wa.me/123233' // URL (used in image generation)
    ], 
];
...
Jika Ingin Menyewa 𝘒𝘢𝘻𝘶𝘩𝘢-𝘔𝘋 Silahkan Ketik .pembayaran 
`)
}
break
case 'delprem': {
...
reply('𝘒𝘢𝘻𝘶𝘩𝘢-𝘔𝘋 SUKSES MODE PUBLIC')
}
break
case 'self': {
if (!isCreator) return mess.owner
Fernazerini.public = false
reply('𝘒𝘢𝘻𝘶𝘩𝘢-𝘔𝘋 SUCCES MODE SELF')
}
break
//================ D O W N L O A D ==================//
...
Done Bwang Kuhhh Kamu Sekarang Sudah Bisa Mengakses 𝘒𝘢𝘻𝘶𝘩𝘢-𝘔𝘋 Abangkuhh Btw Limit Gada Reset Reset an Jika Limit Habis Silahkan Buy Limit Di kyami`
veri = m?.sender
if (!m.isGroup) {
...
case 'tutorial': {
await loading()
tut = `ᴛᴜᴛᴏʀ ʀᴜɴ ᴘᴀɴᴇʟ ʙʏ kyami
https://youtube.com/@slnckyami`
await Fernazerini.relayMessage(m.chat,  {
requestPaymentMessage: {
currencyCodeIso4217: 'IDR',
amount1000: 1000000000,
...
case 'backup':
        {
          if (!isCreator) return reply(mess.owner)
     await reply("ᴡᴀɪᴛ ʙᴀᴄᴋᴜᴘ sᴄ Kazhua ᴠ4.5");
...
Itulah Rules 𝘒𝘢𝘻𝘶𝘩𝘢-𝘔𝘋 Kak Jangan Langgar Ya Kak`)
...
if (!isAdmins) return m.reply('ᴋʜᴜsᴜs ᴀᴅᴍɪɴ ɢʀᴏup')
                ...
                case 'invite': {
	if (!m.isGroup) return reply(`khusus group`)
	if (!isBotAdmins) return reply(`𝘒𝘢𝘻𝘶𝘩𝘢 belum admin`)
...
Fernazerini.sendMessage(m.sender, { image: { url: yeha }, caption : '© 𝘒𝘢𝘻𝘶𝘩𝘢-𝘔𝘋 2023 - 2024'}, { quoted: m })
}
break
case 'tiktokgirl':
await loading()
...
if (!m.isGroup) return reply(`Khusus Group`)
if (!isAdmins) return reply(`Khusus admin`)
if (!isBotAdmins) return reply(`Jadikan 𝘒𝘢𝘻𝘶𝘩𝘢 Admin Dulu`)
...
mediaType:  1,
mediaUrl: 'https://wa.me/123233',
title: `𝙆𝙔𝘼𝙈𝙄 𝙄𝙉 𝙃𝙀𝙍𝙀`,
sourceUrl: `https://wa.me/+123233`, 
thumbnail: thumb
}
}})
break
...
Fernazerini.sendMessage('123233@s.whatsapp.net', { text: `*ADA YANG DEPOSIT NIH*\n\n*@${sender.split('@')[0]}`, mentions: [sender]}, { quoted: m })
        }
        break
        case 'dana': {
...
mediaType:  1,
mediaUrl: 'https://youtube.com/@slnckyami-',
title: `Converter mp3`,
...
buttons: [{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"No\",\"url\":\"https://wa.me/123233\",\"merchant_url\":\"https://wa.me/\"}`
}, {
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"Channel \",\"url\":\"https://chat.whatsapp.com/\",\"merchant_url\":\"https://whatsapp.com/channel/\"}`
}, {
"name": "cta_url",
